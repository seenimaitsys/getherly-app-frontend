...
const Privacy = () => {
  return (
    <>
      <Container>
        <section className="bg-light wrapper">
          <div className="container ">
            ...
            <ul>
              ...
              <li>
                ...
                "Our" in this Agreement) refers to Twigscorp.
              </li>
            ...
            <h4 className="mt-5">Personal Data</h4>
            <p>
            ...
            <h4 className="mt-5">Usage Data</h4>
            ...
            <h4 className="mt-5">Use of Your Personal Data</h4>
            ...
            <h4 className="mt-5">Retention of Your Personal Data</h4>
            <p>
            ...
            <h4 className="mt-5">Transfer of Your Personal Data</h4>
            <p>
            ...
            <h4 className="mt-5">Disclosure of Your Personal Data</h4>
            ...
            <h4 className="mt-5">Other legal requirements</h4>
            <p>
            ...
            <h4 className="mt-5">Security of Your Personal Data</h4>
            <p>
            ...
            <h4 className="mt-5">Analytics</h4>
            <p>
            ...
            <ul>
              ...
              <li>
                By sending us an email: <a> support@twigscorp.com</a>
              </li>
            </ul>
          </div>
        </section>
