...
import GojsViewSlider from "../GojsViewSlider";
...
const LoginForm = () => {
  ...
  return (
    <>
      {/* <Container className="login-continer-main" fluid>
        <img
          src={image16}
          alt="image1"
          loading="lazy"
          className="img-child1"
        ></img>
        <img src={image19} alt="" loading="lazy" className="img-child2"></img>

        <Container className="login-continer">
          <div className="gethely-logo-login">
            <Row>
              <svg
      ...
      <Container className=" login-continer-main" fluid>
        ...
        <Container className=" login-continer">
          <Row className="gethely-logo-login ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
              height="50"
          ...
          <Form className="gap-5" action={<GojsViewSlider />}>
