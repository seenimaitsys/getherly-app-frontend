...
export const DynamicData_form = [
  {
    ...
    Input_Type: (
      <Form.Control
        ...
        name="name"
        autoComplete="off"
        className=" h-40 bg-add-persion-input-bg d-flex  border-0 rounded"
        required
      />
    ),
  },
  {
    ...
    Input_Type: (
      <Form.Select
        required
        className=" bg-add-persion-input-bg h-40 bg-select-custom-icon  d-flex border-0 rounded "
        autoComplete="off"
        name="relationship"
        role="button"
  ...
  },
  {
    ...
    Input_Type: (
      <Form.Control
        ...
        name="phone"
        autoComplete="off"
        className="numberinput h-40 bg-add-persion-input-bg d-flex w-100 align-items-start border-0 rounded"
        required
      />
    ),
  },
